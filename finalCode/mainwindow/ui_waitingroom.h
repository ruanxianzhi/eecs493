...
public:
    ...
    void setupUi(QDialog *waitingroom)
    {
        ...
        pushButton->setGeometry(QRect(480, 450, 181, 61));
...
"border-width: 5px;\n"
                                                "border-radius: 15px;"));
        pushButton_6 = new QPushButton(waitingroom);
        pushButton_6->setObjectName(QStringLiteral("pushButton_6"));
        pushButton_6->setGeometry(QRect(250, 450, 181, 61));
        pushButton_6->setStyleSheet(QLatin1String("border-color: #FFFF33;background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 #6CC9EB, stop: 1 #0d5ca6); \n"
                                                "font: 36pt \"HanziPen SC\";\n"
                                                "border-width: 5px;\n"
                                                "border-radius: 15px;"));
    ...
    void retranslateUi(QDialog *waitingroom)
    {
        ...
        pushButton_6->setText(QApplication::translate("waitingroom", "Start", 0));
