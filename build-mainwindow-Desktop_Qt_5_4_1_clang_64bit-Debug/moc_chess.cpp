...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_chess_t, stringdata) + ofs \
...
const QMetaObject chess::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_chess.data,
...
void *chess::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_chess.stringdata))
